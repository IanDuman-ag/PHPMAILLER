...
<body>
    <div class="login-form">
        ...
        <p class="text-center">Enter your registered email to receive a verification code.</p>
        <form action="./endpoint/send-reset.php" method="POST">
            <div class="form-group">
                <label for="email">Email</label>
                <input type="email" class="form-control" id="email" name="email" required>
            </div>
            <button type="submit" class="btn btn-secondary form-control" name="request_reset">Send Verification Code</button>
